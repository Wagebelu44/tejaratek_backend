...
<?php $__env->startSection('title'); ?>
 <?php echo e(\App\Http\Helpers\Helpers::stringReplace($setting->name_ar,3)); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('description'); ?>
   <?php echo e(\App\Http\Helpers\Helpers::stringReplace($setting->description,3)); ?>
					...
					<div class="row">
						<div class="col-lg-8" data-aos="fade-up"> 
							<div class="header-box"> 
								<h1 class="title"><?php echo $data['slider']->details; ?></h1>
							</div> 
						</div>  
					</div>
					<div class="row">
						<div class="col-lg-12 text-right" data-aos="fade-up"> 
							<img src="<?php echo e(URL::to('/')); ?>/uploads/<?php echo e($data['slider']->image); ?>" class="img-fluid" alt="header-bg">
						</div> 
					</div>
				</div>
			</div> 
				...
				<div class="row justify-content-center">
					<div class="col-lg-6" data-aos="fade-up">
						<div class="section-title"> 
							<p><?php echo e($data['statistics_st']->title); ?></p>
							<h2><?php echo $data['statistics_st']->details; ?></h2>
						</div>
					</div>
				</div>
				<div class="row">
          <?php $i=1; ?>
          <?php $__currentLoopData = $data['statistics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
							...
							<div class="features-box-content">
								<p class="title" data-aos="fade-up"><?php echo e($s->name); ?></p>
								<h2 class="count" data-aos="fade-up"><?php echo e($s->number); ?></h2>
							</div>
						</div>
          </div>
          <?php $i++; ?>
		...
		<section id="products" class="bg-light">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-6" data-aos="fade-up">
						<div class="section-title"> 
							<p><?php echo e($data['products_st']->title); ?></p>
							<h2 class="text-bold"><?php echo $data['products_st']->details; ?></h2>
						</div>
					</div>
				</div>
				<div class="row">
              ...
              <?php $__currentLoopData = $data['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<a href="#!" class="products-box">
								<div class="products-box-pic">
									<img src="<?php echo e(URL::to('/')); ?>/uploads/<?php echo e($p->photo); ?>" alt="card">
								</div>
								<div class="products-box-content">
									<h2 class="title"><?php echo e($p->title); ?></h2>
									<p class="desc"><?php echo $p->details; ?></p> 
								</div>
              </a> 
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="row">
					<div class="col-lg-4" data-aos="fade-up">
						<div class="section-title text-left mt-5 pt-5"> 
							<p>الخدمات</p>
							<h2 class="text-bold mb-3"><?php echo e($data['service_t']->title); ?></h2>
							<p><?php echo $data['service_t']->details; ?></p>
						</div> 
					</div> 
					<div class="col-lg-8">
						<div class="row">
                <?php $i=1; ?>
                <?php $__currentLoopData = $data['service']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  							<div class="col-sm-6">
								<div class="services-box <?php if($i==1): ?>red <?php elseif($i==2): ?> blue <?php else: ?> yellow <?php endif; ?>" data-aos="fade-up">
									<div class="icon">
                    <?php if($i==1): ?>
		...
		<section id="portfolio" class="bg-light">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-12" data-aos="fade-up">
						<div class="section-title text-left"> 
							<p><?php echo e($data['business']->title); ?></p>
							<h2 class="text-bold"><?php echo $data['business']->details; ?></h2>
						</div>
					</div>
				</div>  
              ...
              <?php $__currentLoopData = $data['category']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<a  href="<?php if($c->url): ?> <?php echo e($c->url); ?> <?php else: ?> echo #!  <?php endif; ?>" <?php if($c->url): ?>  target="_blank" <?php endif; ?> class="portfolio-box"> 
								<img src="<?php echo e(URL::to('/')); ?>/uploads/<?php echo e($c->photo); ?>" alt="Card">  
								<h2 class="title"><?php echo e($c->title); ?></h2>  
              </a> 
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		<section id="partners">
			<div class="container"> 
				<div class="row justify-content-center">
					<div class="col-lg-6" data-aos="fade-up">
						<div class="section-title"> 
							<h2 class="text-bold"><?php echo e($data['clients']->title); ?></h2> 
						</div>
					</div>
				</div> 
				<div class="row">
              ...
              <?php $__currentLoopData = $data['our_clients']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<a href="<?php if($ci->url): ?> <?php echo e($ci->url); ?> <?php else: ?> echo #!  <?php endif; ?>" <?php if($ci->url): ?>  target="_blank" <?php endif; ?> class="partner-box">
								<img src="<?php echo e(URL::to('/')); ?>/uploads/<?php echo e($ci->image); ?>" alt="<?php echo e($ci->title); ?>">
              </a>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div> 
					</div> 
				...
				<div class="row">
					<div class="col-lg-12"> 
						<div class="new-project-box">
							<div class="content">
								<h2 class="title" data-aos="fade-up"><?php echo e($data['project']->title); ?></h2>
								<p class="desc" data-aos="fade-up"><?php echo $data['project']->details ?? ''; ?></p>
								<a href="#subscribe" data-aos="fade-up" class="btn btn-scroll"> تواصل معنا </a>
							</div>
							<img src="<?php echo e(URL::to('/')); ?>/site/assets/img/comp.png" alt="comp" data-aos="fade-up">
						</div>
					</div> 
				</div> 
			</div>
		...
		<section id="subscribe">
			<div class="container"> 
				<div class="row">
					<div class="col-lg-6" data-aos="fade-up">
						<div class="section-title text-left"> 
							<h2 class="text-bold"><?php echo $data['request_projects']->details ?? ''; ?></h2> 
						</div>
					</div>
				</div> 
				<div class="row">
                ...
                <?php echo csrf_field(); ?>
                          ...
                          <?php $__currentLoopData = $data['currency']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$('#form_contact').on('submit', function(e){
  ...
  var formData = new FormData(this);
    ...
    $.ajax({
        url: "<?php echo e(URL::to('/')); ?>/project_request",
        type: "post",
        cache:false,
        contentType: false,
        processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\tejartek\resources\views/site/index.blade.php ENDPATH**/ ?>