...
<!-- <div class="m-subheader-search">
							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										...
										<a href="/admin/our_clients" class="m-nav__link">

											<span class="m-nav__link-text">عملائنا</span>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> إضافة عميل جديد</button>
...
عملائنا
	...
	<div id="table-container">
        ...
        <?php echo $__env->make('admin.ourclients.table-data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.ourclients.sub.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
/***********************************************************************************************************************/
        ...
        $('body').on('click','.UpdateStats',function(){
            ...
            $.ajax({
            	...
            	url: "/admin/our_clients/UpdateStats",
...
<script type="text/javascript">
	...
	$(document).on('click','.delete',function(e){
		...
		Swal.fire({
                ...
                url: "/admin/our_clients/delete/"+id,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\tejartek\resources\views/admin/ourclients/index.blade.php ENDPATH**/ ?>