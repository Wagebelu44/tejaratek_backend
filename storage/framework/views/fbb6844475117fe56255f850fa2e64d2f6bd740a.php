...
<!-- <div class="m-subheader-search">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/contact" class="m-nav__link">
											<span class="m-nav__link-text"> البريد الوارد</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
                ...
                <button type="button"   class="btn btn-success m-btn m-btn--custom btn_addexcel" style="line-height: 15px;
                padding-bottom: 15px;"><i class="fas fa-file-excel"></i> تصدير إكسل للكل</button>
                <?php endif; ?>	
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\tejartek\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>