...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Styles -->
		<link rel="shortcut icon" href="/admin/assets/demo/demo6/media/img/logo/main-logo.svg" />
				...
				<div class="m-grid__item m-grid__item--fluid m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<img width="150px" alt="" src="/admin/assets/demo/demo1/media/img/logo/main-logo.svg" />
							</a>
						</div>
						<div class="m-login__signin">
							<div class="m-login__head">
								<h3 class="m-login__title">{{__('text.login')}} </h3>
							</div>
			        	<form class="m-login__form m-form" action="/admin/adminlogin" method="post">
								...
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="text"  autocomplete="off" placeholder="{{__('text.username')}}" name="username" required>
								</div>
								<div class="form-group m-form__group">
									<input class="form-control m-input m-login__form-input--last" type="password" type="password" autocomplete="off" placeholder="{{__('text.password')}}" name="password" required>
								</div>
								...
								<div class="m-login__form-action">
									<button id="m_login_signin_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn m-login__btn--primary">{{__('text.login')}} </button>
								</div>
							</form>
						</div>
