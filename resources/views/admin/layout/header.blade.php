                    ...
                    <div class="m-stack__item m-brand">
                        <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a href="{{ route('admin.dashboard.view') }}" class="m-brand__logo-wrapper">
                            ...
                            <div class="m-stack__item m-topbar__nav-wrapper">
                                <ul class="m-topbar__nav m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                     m-dropdown-toggle="click">
                                        <a href="#" class="m-nav__link m-dropdown__toggle">
                                            <span class="m-topbar__welcome">{{__('text.hello')}},&nbsp;</span>
                                            <span class="m-topbar__username">{{Auth::user()->username}}</span>
                                                        ...
                                                        <ul class="m-nav m-nav--skin-light">
                                                            ...
                                                            <ul class="m-nav m-nav--skin-light">
                                                                ...
                                                                <li class="m-nav__item text-center" style="margin-bottom: 20px;">
                                                                  <a href="{{ route('admin.dashboard.profile') }}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">{{__('text.profile')}}</a>
                                                                </li>
                                                                @if(false)
                                                                <li class="m-nav__item text-center" style="margin-bottom: 20px;">
                                                                  <a href="{{ url('locale/ar') }}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">عربية</a>
                                                                  <a href="{{ url('locale/en') }}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">english</a>
                                                                </li>
                                                                @endif
                                                                <li class="m-nav__item text-center">
                                                                    <a href="{{ route('admin.dashboard.logout') }}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{__('text.logout')}}</a>
