...
<section class="contact">
			<div class="container"> 
					...
					<div class="col-lg-3 col-md-4">
						<div class="contact-box">
							...
							<div class="contact-box-content"> 
								<p class="description">{{$data['setting']->location}}</p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-4">
						<div class="contact-box">
							...
							<div class="contact-box-content"> 
								<p class="description">{{$data['setting']->mobile}}</p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-4">
						<div class="contact-box">
							...
							<div class="contact-box-content"> 
								<p class="description">{{$data['setting']->email}}</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-9">
						<h4 class="py-4 text-center">{!! $data['contact']->details !!}</h4>
