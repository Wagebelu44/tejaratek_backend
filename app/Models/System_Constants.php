...
class System_Constants extends Model
{
    ...
    public function getSystem($name,$type){
        ...
        return $system = $system->where('system_constants.type','!=','system_constants')->select(['system_constants.id','system_constants.name_ar','system_constants.status','system_constants.type','sys.name_ar as type_name'])->paginate(8);
    }
